# The name of this view in Looker is "Etf Raw"
view: etf_raw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `HKEx_demo_securities_attribute.etf_raw` ;;
  ...
  dimension: amt_os {
    type: number
    description: "Amount outstanding (Indicate the number of ETF outstanding in the market)"
    sql: ${TABLE}.AMT_OS ;;
  }
  ...
  dimension: rep_method {
    type: string
    description: "To indicate the replication method of the ETF. Possible values are : ‘0001’ – Physical ‘0002’ – Synthetic ‘0003’ – Futures Based"
