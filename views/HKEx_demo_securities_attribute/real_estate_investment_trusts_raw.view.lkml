# The name of this view in Looker is "Real Estate Investment Trusts Raw"
view: real_estate_investment_trusts_raw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `HKEx_demo_securities_attribute.real_estate_investment_trusts_raw` ;;
  ...
  dimension: amt_os {
    type: number
    description: "Amount outstanding (Indicate the number of REIT outstanding in the market)"
    sql: ${TABLE}.AMT_OS ;;
  }
