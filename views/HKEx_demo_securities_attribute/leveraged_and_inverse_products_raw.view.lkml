# The name of this view in Looker is "Leveraged and Inverse Products Raw"
view: leveraged_and_inverse_products_raw {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `HKEx_demo_securities_attribute.leveraged_and_inverse_products_raw` ;;
  ...
  dimension: amt_os {
    type: number
    description: "Amount outstanding (Indicate the number of L\u0026IP outstanding in the market)"
    sql: ${TABLE}.AMT_OS ;;
  }
  ...
  dimension: lev_inv_factor {
    type: number
    description: "To indicate the corresponding leverage / inverse factor"
    sql: ${TABLE}.LEV_INV_FACTOR ;;
  }
  ...
  dimension: rep_method {
    type: string
    description: "To indicate the replication method of the L\u0026I Product. Possible values are : ‘0001’ – Futures Based ‘0002’ – Swap Based"
    sql: ${TABLE}.REP_METHOD ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [short_name, under_name, full_name]
  }
}
